...
class Shop extends handy.system.BaseClass {
  ...
  isValidSignature(params, non_state){
    handy.system.log({req, level: 'info', category: 'system', msg: 'Begin of isValidSignature'});
...
//    const requestVerified = shop.Shopify.is_valid_signature(queryClone, true);
  ...
  handy.system.log({req, level: 'info', category: 'system', msg: 'End of _authenticateRegularShopifyRequests'});
}
...
function _internalUrlHashValidation(query){
  handy.system.log({req, level: 'info', category: 'system', msg: 'Begin of _internalUrlHashValidation'});
